...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250311203913_ImagePublicId_added_to_Attachment")]
    partial class ImagePublicId_added_to_Attachment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.MuxData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Domain.MuxData", b =>
                {
                    b.HasOne("Domain.Chapter", "Chapter")
                        .WithOne("MuxData")
                        .HasForeignKey("Domain.MuxData", "ChapterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
